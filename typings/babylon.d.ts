...
declare module BABYLON {
    class ActionEvent {
        ...
        public pointerY: number;
        public meshUnderPointer: AbstractMesh;
        constructor(source: AbstractMesh, pointerX: number, pointerY: number, meshUnderPointer: AbstractMesh);
...
declare module BABYLON {
    ...
    class SetStateAction extends Action {
        public value: string;
        private _target;
        constructor(trigger: number, target: any, value: string, condition?: Condition);
        public execute(): void;
    }
    ...
    class ExecuteCodeAction extends Action {
        ...
        constructor(trigger: number, func: (evt: ActionEvent) => void, condition?: Condition);
        public execute(evt: ActionEvent): void;
    }
